...
REQUIRED_PKGS="ca-certificates git-core binutils libasound2-dev libva1 libpcre3-dev libidn11-dev libboost-dev libfreetype6-dev libdbus-1-dev libssl-dev libssh-dev libsmbclient-dev gcc g++ sed pkg-config"
MISSING_PKGS=""
